...
tank_temp_sensor = 'Input-Temp-GarageWaterButt'
depth_sensor = 'Input-Depth-GarageWaterButt'
 
-- Output devices: Percentage full, volume.
pct_sensor = 'WaterButt-Garage-Percentage'
pct_sensor_id = 287
volume_sensor = 'WaterButt-Garage-Litres'
volume_sensor_id = 288
